/* A simple demo of JTextField.
 * When user presses Enter key in either of textField1 or textField2, 
 * textField3 is updated with textField1 text followed by space character 
 * and textField2 text
 * 
...
public class SimpleDemo extends JFrame {
         ...
         public static void main(String[] args) {
		    new SimpleDemo();  //Initialize BlankJavaGUI frame
		 }
}
